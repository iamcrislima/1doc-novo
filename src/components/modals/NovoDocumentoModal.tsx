...
export default function NovoDocumentoModal({ open, onClose }: Props) {
  ...
  // Sector picker (shared — Ata destinatário, Circular Para)
        ...
        <div className="ndm-setor-picker" ref={tipoDocDropRef}>
          <div className="ndm-select-custom" onClick={() => setShowTipoDocDrop(true)}>
            <input
              ...
              value={showTipoDocDrop ? tipoDocSearch : tipoDocumento}
              onChange={(e) => { setTipoDocSearch(e.target.value); setShowTipoDocDrop(true); }}
              onFocus={() => { setTipoDocSearch(""); setShowTipoDocDrop(true); }}
            />
    ...
    <>
      ...
      <div className="ndm-row-3">
        ...
        <div className="ndm-field">
          ...
          <textarea
            className="ndm-textarea"
            placeholder="Liste os objetivos da reunião..."
            value={objetivos}
        ...
        <div className="ndm-field">
          ...
          <textarea
            className="ndm-textarea"
            placeholder="Registre os tópicos abordados..."
            value={topicos}
    ...
    <>
      ...
      <div className="ndm-field">
        ...
        <input
          className="ndm-input"
          type="date"
          value={autoArquivamento}
          onChange={(e) => setAutoArquivamento(e.target.value)}
        />
      </div>
  ...
  const cicloVidaFields = (
    <>
      <div className="ndm-info-banner">
        ...
        <span>
          O ciclo de vida será iniciado automaticamente após a postagem.
          Todos os responsáveis serão notificados conforme o fluxo configurado.
        </span>
      </div>
