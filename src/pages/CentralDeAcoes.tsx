...
const COUNTERS = [
  ...
  { id: "assinaturas-solicit",   title: "Assinaturas solicitadas",counter: 24, iconClass: "fa-solid fa-file-signature",  iconColor: "green" },
...
const LISTS = [
  ...
  {
    id: "assinaturas-solicit", subtitle: "Assinaturas solicitadas", footerLabel: "Assinaturas Solicitadas", footerIcon: "fa-regular fa-file-signature",
    items: [
  ...
  return (
    <div className="cda">
      ...
      <div className="cda__grid">
        ...
        {/* Comunicados: col 5, span row 1+2 */}
